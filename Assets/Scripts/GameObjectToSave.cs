...
//Helper Class for serializating a Unity GameObject.
[Serializable]
public class GameObjectToSave
{
    public float posX;
    ...
    public GameObjectToSave(float posX, float posY, float posZ, float rotX = 0.0f, float rotY = 0.0f, float rotZ = 0.0f, float scaleX = 1.0f, float scaleY = 1.0f, float scaleZ = 1.0f)
    {
        PosX = posX;
        PosY = posY;
        PosZ = posZ;
